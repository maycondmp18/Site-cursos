...
$sql = $conn->query("SELECT MAX(id) AS id FROM dadosvendas");
...
<html lang="pt-br">
    <head>
        <meta charset="UTF-8">
        <title>Mult Soluções - PagSeguro</title>
            ...
            <div class="row">
                ...
                <div class="col-md-8 order-md-1">
                    ...
                    <form name="formPagamento" action="" id="formPagamento">
                        ...
                        <div class="mb-3">
                            <label>Nome</label>                            
                            <input type="text" name="senderName" id="senderName" placeholder="Nome completo" class="form-control" required>                        
                        </div>
                        ...
                        <div class="mb-3">
                            <label>E-mail</label>  
                            <input type="email" name="senderEmail" id="senderEmail" placeholder="E-mail do comprador" class="form-control" required>                                                
                        </div>

                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <label>DDD</label>
                                <input type="text" name="senderAreaCode" id="senderAreaCode" placeholder="DDD" class="form-control" required>
                            </div>
                            <div class="col-md-9 mb-3">
                                <label>Telefone</label>
                                <input type="text" name="senderPhone" id="senderPhone" placeholder="Somente número" class="form-control" required>
                            </div>
                        </div>

                        <h4 class="mb-3 end_entrega">Endereço de Entrega</h4>

                        <input type="hidden" name="shippingAddressRequired" id="shippingAddressRequired" value="true">

                        <div class="row end_entrega">
                            <div class="col-md-9 mb-3">
                                <label>Logradouro</label>
                                <input type="text" name="shippingAddressStreet" class="form-control" id="shippingAddressStreet" placeholder="Av. Rua" value="<?php echo @$endereco ?>" required>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label>Número</label>
                                <input type="text" name="shippingAddressNumber" class="form-control" id="shippingAddressNumber" placeholder="Número" value="<?php echo @$endereco ?>" required>
                            </div>
                        </div>

                        <div class="mb-3 end_entrega">
                            <label>Complemento</label>
                            <input type="text" name="shippingAddressComplement" class="form-control" id="shippingAddressComplement" placeholder="Complemento" value="<?php echo @$endereco ?>">
                        </div>

                        <div class="row end_entrega">
                            <div class="col-md-5 mb-3">
                                <label>Bairro</label>
                                <input type="text" name="shippingAddressDistrict" class="form-control" id="shippingAddressDistrict" placeholder="Bairro" value="<?php echo @$endereco ?>" required>
                            </div>
                            <div class="col-md-5 mb-3">
                                <label>Cidade</label>
                                <input type="text" name="shippingAddressCity" class="form-control" id="shippingAddressCity" placeholder="Cidade" value="<?php echo @$endereco ?>" required>
                            </div>
                        ...
                        <div class="mb-3 end_entrega">
                            <label>CEP</label>
                            <input type="text" name="shippingAddressPostalCode" class="form-control" id="shippingAddressPostalCode" placeholder="CEP sem traço" value="<?php echo @$cep ?>" required>
                        </div>
                        ...
                        <input type="hidden" name="amount" id="amount" value="<?php echo $valor ?>">
