  ...
  <body>
    ...
    <section class="contact_area section_gap">
        <div class="container text-center">
            ...
            ?>
            <p>
            Acesse sua conta, ou <a href="registro.php">cadastre-se aqui</a></p>
            <form action="login.php" method="post">
                ...
                <div class="row mt-4 justify-content-center">
                    <div class="col-md-8">
                        <button type="submit" name="login" class="btn btn-outline-primary" style="heigth: 100px; width: 120px;">Entrar</button>
                    </div>
                </div>
            </form>
        </div>
