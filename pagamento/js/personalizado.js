    ...
    if(paymentMethod == 'creditCard'){
        PagSeguroDirectPayment.createCardToken({
            ...
            success: function (retorno) {
                ...
                recupHashCartao(); //Mover para a função success
            },
            error: function (retorno) {
                // Callback para chamadas que falharam.
            },
        ...
        if (retorno.status == 'error') {
            ...
            $.ajax({
                ...
                success: function(retorna){
                    ...
                    $('#msg').html("<p style='color: green'>Transação realuzada com sucesso</p>");
                    //window.location.href = endereco + 'notifica.php';

                },
                error: function(retorna){
                    console.log("Erro");
                    console.log(retorna);
                    $('#msg').html("<p style='color: red'>Erro ao realizar transação</p>"); 
                }
            });
        }
    });
