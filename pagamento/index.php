            ...
            <div class="row">
                ...
                <table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <input type="hidden" value="<?php echo $row['nome']; ?>" id="produto">

                                <th scope="row" style="text-align: center;"><?php echo number_format($row['preco'], 2, '.', ''); ?></th>  
                                <input type="hidden" value="<?php echo $row['preco']; ?>" id="preco">
                ...
                <div class="col-md-8 order-md-1">
                    ...
                    <form name="formPagamento" action="" id="formPagamento">
                        ...
                        <input type="submit" class="btn btn-primary mb-3" name="btnComprar" onclick="cadPedido()" id="btnComprar" value="Comprar">
                    </form>
                </div>
            </div>
        </div>
