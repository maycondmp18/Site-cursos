...
$code = $conn->prepare("INSERT INTO vendas (tipo_pg, cod_trans, status, referencia, link_pagamento, criacao) VALUES (:tipo_pg, :cod, :status, :ref, :link, NOW())");
...
$code->bindParam(':ref', $xml->reference, PDO::PARAM_INT);
