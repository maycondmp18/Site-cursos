    ...
    <div class="container mt-3 mb-3" style="height: 400px; display: flex; flex-direction: column; align-items: center;">
        ...
        <table class="table table-striped">
            <tr class='text-center'>
                <td style='text-transform: uppercase;'>Alunos</td>
            ...
            id aluno tem que esta em cursos adiquiridos
            o curso adiquirido tem que ter o id do professor que esta logado
            ...
            <?php 
                ...
                while($ln = $curso->fetch(PDO::FETCH_ASSOC)){
                  $al = $conn->query("SELECT id_aluno FROM cursos_adquiridos WHERE id_curso = '" . $ln['id_curso'] . "'");
                  while($row = $al->fetch(PDO::FETCH_ASSOC)){
                      $g = $conn->query("SELECT nome, email FROM alunos WHERE id = '" . $row['id_aluno'] . "'");
                      while($r = $g->fetch(PDO::FETCH_ASSOC)){
            ?>
                <tr>
