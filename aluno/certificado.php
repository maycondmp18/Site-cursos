                ...
                <div class="animated">     
                    <div class="row" id="page1">
                        <?php
                            ...
                            $code = $conn->query("SELECT arquivo FROM certificados WHERE id_aluno = '$aluno'");
                            $row = $code->rowCount();
                            if($row > 0){
                                ...
                                <div class="card-body" style='height: 70px;'>
                                    <div class="stat-widget-five">
                                        <div class="text-center dib">
                                            <div class="stat-text ">
                                                <span ><a href="../torage/certificate/<?php echo $ln['arquivo'] ?>" class=" text-white"><?php echo $ln['arquivo'] ?></a></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <?php }
                                ...
                                echo "<h2>Você ainda não possui certificados para serem exibidos</h2>";
                            }
                        ?>
                    </div>
                </div>  
