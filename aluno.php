    ...
    <section class="banner_area">
      ...
      <div class="wrapper d-flex align-items-stretch" style="background: #eeeeee;">
        ...
        <div id="content" class="container">
            <div class="animated">
                <div class="container mt-3 mb-3" style="height: 50px; display: flex; flex-direction: column; align-items: center;">

                    <div class="group mb-4">
                        <a href="aluno/cursos.php" class="btn custom-btn text-white aluno" style="background: #002347;">Cursos</a>
                        <a href="aluno/certificado.php" class="btn custom-btn text-white curso" style="background: #002347;">Certificados</a>
                        <a href="aluno/perfil.php" class="btn custom-btn text-white certificado" style="background: #002347;">Perfil</a>
                    </div>
